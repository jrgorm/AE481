...
[WeoverMTOW] = EmptyweightIII(parameters,tailParameters);

%%% Compute Fuel and Empty Weights

%RUN FUEL WEIGHT CODExxxxxxxxxxxxxxxxxxxxxxxxxx
%xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
%%%% INPUT!!!!: fuel weight over MTOW (from john's code) : will need to be found from John's fuel code

Wfuel = parameters.Wfuel;  %%%% Note, WfoverMTOW will be found from a function call (above this line) of John's fuel weight code
