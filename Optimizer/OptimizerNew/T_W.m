...
function [parameters] = T_W(parameters,dragP)
...
K_cruise = dragP.K_cruise;

Neng = parameters.Neng;

q_cruise = parameters.qCruise;

CD0_climb_1 = dragP.CD0_climb_1;
CD0_climb_2 = dragP.CD0_climb_2;
CD0_climb_3 = dragP.CD0_climb_3;   

CD0_cruise = dragP.CD0_cruise;

CL_landing = dragP.CL_landing;
...
thrustParameters.T_W_takeoff = W_S/((rho_EWR/rho_SIN)* dragP.CL_climb*TOP);
...
%Dynamic Pressure
q_maneuver = .5*parameters.rhoCruise*v_maneuver^2;
...
parameters.T0 = thrustParameters.T_W_design * W0;
